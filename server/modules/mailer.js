...
//        "<p>Registration code is valid for 1 hour</p>" +
        ...
        "<p>Welcome to Azart Trade!</br></br>Best Regards,<br>Azart Trade Team";
    
    try
    {
        let isSent = false;
        sendmail({
            from: 'Azart Trade Mailer <'+g_constants.NOREPLY_EMAIL+'>',
...
exports.SendPasswordResetConfirmation = function(email, user, url, urlCheck, callback)
{
    ...
    const body = 
        ...
        "<p>Someone requested that the password for your Azart Trade account be reset</p>" +
        "<p>"+confirmHREF+"</p>" +
        ...
        "<p>This is an automated message. Please, do not reply to it.</p>" +
        "</br></br>Best Regards,<br>Azart Trade Team";
...
exports.SendWithdrawConfirmation = function(email, user, url, urlCheck, callback)
{
    ...
    const body = 
        "<h3>Hello "+unescape(user)+"</h3>" +
        "<p>Someone requested withdraw from your Azart Trade balance</p>" +
        "<p>"+confirmHREF+"</p>" +
